...
# USE_LINEAR_EOM = False, name = name, timestep = 1/50, v = 3.0)

# # VI_model.train( gamma = 1, num_episodes = 200,
...
for starting_state in [6]:
  ...
  #   USE_LINEAR_EOM = False, timestep = 1/50, v = 3.0)
